...
class ClientPrefs {
	...
	public static var nomidsongcutscene:Bool = false;
	public static var nodad:Bool = false;
	public static var noexdad:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.nomidsongcutscene = nomidsongcutscene;
		FlxG.save.data.nodad = nodad;
		FlxG.save.data.noexdad = noexdad;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.nomidsongcutscene != null) {
			nomidsongcutscene = FlxG.save.data.nomidsongcutscene;
		}

		if(FlxG.save.data.noexdad != null) {
			noexdad = FlxG.save.data.noexdad;
		}
