...
class CustomControlsState extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		dodge_text = new FlxText(200, 400, 0,"Button dodge x:" + _pad.buttonA.x +" y:" + _pad.buttonA.y, 24);
		
		//hitboxes

		var curcontrol:HitboxType = DODGE;

		_hb = new Hitbox(curcontrol);
		_hb.visible = false;
	...
	function setbuttontexts() {
		...
		dodge_text.text = "Button dodge x:" + _pad.buttonA.x +" y:" + _pad.buttonA.y;
	}
